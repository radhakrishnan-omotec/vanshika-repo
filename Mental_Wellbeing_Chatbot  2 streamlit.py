...
# Correcting pyparsing compatibility issue
from packaging import version
import pyparsing
if version.parse(pyparsing.__version__) < version.parse("3.0.0"):
    raise RuntimeError("The installed pyparsing version is incompatible. Please upgrade pyparsing to 3.0.0 or later.")
